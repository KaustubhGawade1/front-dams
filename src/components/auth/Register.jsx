...
const Register = () => {
    ...
    const registerHandler = async (data) => {
        ...
        // Convert single role to array to match backend Set<String>
        data.role = [data.role];
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-1 w-full">
                        ...
                        <select
                            ...
                            className="px-2 py-2 border outline-none bg-transparent text-slate-800 rounded-md border-slate-700"
                        >
